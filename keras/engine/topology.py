...
class Container(Layer):
    ...
    def summary(self, print=print, line_length=100, positions=[.33, .55, .67, 1.]):
...
#<<<<<<< HEAD
        ...
        print_summary(flattened_layers, getattr(self, 'container_nodes', None), print=print, line_length=line_length, positions=positions)
#=======
